...
pub export fn GuiIconText(arg_iconId: c_int, arg_text: [*c]const u8) [*c]const u8 {
    ...
    if (text != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        ...
        _ = sprintf(@as([*c]u8, @ptrCast(@alignCast(&iconBuffer.static))), "#%03i#", iconId);
    ...
    _ = &toggle;
    {
        ...
        while (i < count) : (i += 1) {
            ...
            if (tabBounds.x < @as(f32, @floatFromInt(GetScreenWidth()))) {
                ...
                if ((@as(c_int, @intFromBool(CheckCollisionPointRec(GetMousePosition(), tabBounds))) != 0) and (@as(c_int, @intFromBool(IsMouseButtonPressed(MOUSE_BUTTON_MIDDLE))) != 0)) {
                    result = i;
                }
...
pub export fn GuiScrollPanel(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_content: Rectangle, arg_scroll: [*c]Vector2, arg_view: [*c]Rectangle) c_int {
    ...
    if ((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) {
        ...
        if (CheckCollisionPointRec(mousePoint, bounds)) {
            ...
            _ = &wheelMove;
            var mouseWheelSpeed: Vector2 = Vector2{
                .x = content.width / bounds.width,
                .y = content.height / bounds.height,
            };
            _ = &mouseWheelSpeed;
            if (mouseWheelSpeed.x < @as(f32, @floatFromInt(@as(c_int, 20)))) {
                mouseWheelSpeed.x = 20;
            }
            if (mouseWheelSpeed.y < @as(f32, @floatFromInt(@as(c_int, 20)))) {
                mouseWheelSpeed.y = 20;
            }
    ...
    GuiDrawRectangle(bounds, GuiGetStyle(LISTVIEW, BORDER_WIDTH), GetColor(@as(c_uint, @bitCast(GuiGetStyle(LISTVIEW, @as(c_int, @bitCast(@as(c_uint, @bitCast(BORDER)) +% (state *% @as(c_uint, @bitCast(@as(c_int, 3)))))))))), Color{
        .r = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .g = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .b = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .a = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
...
pub export fn GuiButton(arg_bounds: Rectangle, arg_text: [*c]const u8) c_int {
    ...
    var state: GuiState = guiState;
    _ = &state;
    if (((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) and !guiControlExclusiveMode) {
        var mousePoint: Vector2 = GetMousePosition();
        _ = &mousePoint;
        if (CheckCollisionPointRec(mousePoint, bounds)) {
            if (IsMouseButtonDown(MOUSE_BUTTON_LEFT)) {
...
pub export fn GuiComboBox(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_active: [*c]c_int) c_int {
    ...
    if ((((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) and (itemCount > @as(c_int, 1))) and !guiControlExclusiveMode) {
        var mousePoint: Vector2 = GetMousePosition();
        _ = &mousePoint;
...
pub export fn GuiDropdownBox(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_active: [*c]c_int, arg_editMode: bool) c_int {
    ...
    _ = &direction;
    if (GuiGetStyle(DROPDOWNBOX, DROPDOWN_ROLL_UP) == @as(c_int, 1)) {
        direction = 1;
    }
    var itemCount: c_int = 0;
    _ = &itemCount;
    ...
    if (direction == @as(c_int, 1)) {
        boundsOpen.y -= (@as(f32, @floatFromInt(itemCount)) * (bounds.height + @as(f32, @floatFromInt(GuiGetStyle(DROPDOWNBOX, DROPDOWN_ITEMS_SPACING))))) + @as(f32, @floatFromInt(GuiGetStyle(DROPDOWNBOX, DROPDOWN_ITEMS_SPACING)));
    }
    var itemBounds: Rectangle = bounds;
    _ = &itemBounds;
    if ((((state != @as(c_uint, @bitCast(STATE_DISABLED))) and ((@as(c_int, @intFromBool(editMode)) != 0) or !guiLocked)) and (itemCount > @as(c_int, 1))) and !guiControlExclusiveMode) {
        var mousePoint: Vector2 = GetMousePosition();
        _ = &mousePoint;
        if (editMode) {
            state = @as(c_uint, @bitCast(STATE_PRESSED));
    ...
    if (!(GuiGetStyle(DROPDOWNBOX, DROPDOWN_ARROW_HIDDEN) != 0)) {
        GuiDrawText(if (direction != 0) "#121#" else "#120#", Rectangle{
...
pub export fn GuiValueBox(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_value: [*c]c_int, arg_minValue: c_int, arg_maxValue: c_int, arg_editMode: bool) c_int {
    ...
    if (((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) and !guiControlExclusiveMode) {
        ...
        if (editMode) {
            ...
            if (((@as(c_int, @intFromBool(IsKeyPressed(KEY_ENTER))) != 0) or (@as(c_int, @intFromBool(IsKeyPressed(KEY_KP_ENTER))) != 0)) or (!CheckCollisionPointRec(mousePoint, bounds) and (@as(c_int, @intFromBool(IsMouseButtonPressed(MOUSE_BUTTON_LEFT))) != 0))) {
                if (value.* > maxValue) {
                    value.* = maxValue;
...
pub export fn GuiValueBoxFloat(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_textValue: [*c]u8, arg_value: [*c]f32, arg_editMode: bool) c_int {
    var bounds = arg_bounds;
    _ = &bounds;
    var text = arg_text;
    _ = &text;
    var textValue = arg_textValue;
    _ = &textValue;
    var value = arg_value;
    _ = &value;
    var editMode = arg_editMode;
    ...
    if (((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) and !guiControlExclusiveMode) {
        ...
        if (editMode) {
            state = @as(c_uint, @bitCast(STATE_PRESSED));
            var keyCount: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(textValue)))));
            _ = &keyCount;
            if (keyCount < @as(c_int, 32)) {
                if (@as(f32, @floatFromInt(GetTextWidth(textValue))) < bounds.width) {
                    var key: c_int = GetCharPressed();
                    _ = &key;
                    if (((((key >= @as(c_int, 48)) and (key <= @as(c_int, 57))) or (key == @as(c_int, '.'))) or ((keyCount == @as(c_int, 0)) and (key == @as(c_int, '+')))) or ((keyCount == @as(c_int, 0)) and (key == @as(c_int, '-')))) {
                        (blk: {
                            const tmp = keyCount;
                            if (tmp >= 0) break :blk textValue + @as(usize, @intCast(tmp)) else break :blk textValue - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = @as(u8, @bitCast(@as(i8, @truncate(key))));
                        keyCount += 1;
                        valueHasChanged = @as(c_int, 1) != 0;
                    }
                }
    ...
    GuiDrawRectangle(bounds, GuiGetStyle(VALUEBOX, BORDER_WIDTH), GetColor(@as(c_uint, @bitCast(GuiGetStyle(VALUEBOX, @as(c_int, @bitCast(@as(c_uint, @bitCast(BORDER)) +% (state *% @as(c_uint, @bitCast(@as(c_int, 3)))))))))), baseColor);
    GuiDrawText(textValue, GetTextBounds(VALUEBOX, bounds), TEXT_ALIGN_CENTER, GetColor(@as(c_uint, @bitCast(GuiGetStyle(VALUEBOX, @as(c_int, @bitCast(@as(c_uint, @bitCast(TEXT)) +% (state *% @as(c_uint, @bitCast(@as(c_int, 3)))))))))));
    if (editMode) {
        var cursor: Rectangle = Rectangle{
            .x = ((bounds.x + @as(f32, @floatFromInt(@divTrunc(GetTextWidth(textValue), @as(c_int, 2))))) + (bounds.width / @as(f32, @floatFromInt(@as(c_int, 2))))) + @as(f32, @floatFromInt(@as(c_int, 1))),
            .y = bounds.y + @as(f32, @floatFromInt(@as(c_int, 2) * GuiGetStyle(VALUEBOX, BORDER_WIDTH))),
            .width = @as(f32, @floatFromInt(@as(c_int, 4))),
            .height = bounds.height - @as(f32, @floatFromInt(@as(c_int, 4) * GuiGetStyle(VALUEBOX, BORDER_WIDTH))),
        };
...
pub export fn GuiTextBox(arg_bounds: Rectangle, arg_text: [*c]u8, arg_textSize: c_int, arg_editMode: bool) c_int {
    var bounds = arg_bounds;
    _ = &bounds;
    var text = arg_text;
    _ = &text;
    ...
    _ = &textLength;
    var thisCursorIndex: c_int = textBoxCursorIndex;
    _ = &thisCursorIndex;
    if (thisCursorIndex > textLength) {
        thisCursorIndex = textLength;
    }
    var textWidth: c_int = GetTextWidth(text) - GetTextWidth(text + @as(usize, @bitCast(@as(isize, @intCast(thisCursorIndex)))));
    _ = &textWidth;
    ...
    if (((((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !(GuiGetStyle(TEXTBOX, TEXT_READONLY) != 0)) and !guiLocked) and !guiControlExclusiveMode) and (wrapMode == TEXT_WRAP_NONE)) {
        ...
        if (editMode) {
            ...
            _ = &charEncoded;
            if ((((@as(c_int, @intFromBool(multiline)) != 0) and (codepoint == @as(c_int, '\n'))) or (codepoint >= @as(c_int, 32))) and ((textLength + codepointSize) < textSize)) {
                {
            ...
            if (((textLength > @as(c_int, 0)) and (@as(c_int, @intFromBool(IsKeyPressed(KEY_BACKSPACE))) != 0)) and ((@as(c_int, @intFromBool(IsKeyDown(KEY_LEFT_CONTROL))) != 0) or (@as(c_int, @intFromBool(IsKeyDown(KEY_RIGHT_CONTROL))) != 0))) {
                var i: c_int = textBoxCursorIndex - @as(c_int, 1);
                _ = &i;
                var accCodepointSize: c_int = 0;
                _ = &accCodepointSize;
                while ((i > @as(c_int, 0)) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                        const tmp_2 = i;
                        if (tmp_2 >= 0) break :blk_1 text + @as(usize, @intCast(tmp_2)) else break :blk_1 text - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                    }).*)));
                    ...
                    _ = &prevCodepointSize;
                    _ = GetCodepointPrevious(text + @as(usize, @bitCast(@as(isize, @intCast(i)))), &prevCodepointSize);
                    i -= prevCodepointSize;
                ...
                {
                    var j: c_int = textBoxCursorIndex - accCodepointSize;
                    _ = &j;
                    while (j < textLength) : (j += 1) {
                        (blk: {
                            const tmp = j;
                            if (tmp >= 0) break :blk text + @as(usize, @intCast(tmp)) else break :blk text - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = (blk: {
                            const tmp = j + accCodepointSize;
                            if (tmp >= 0) break :blk text + @as(usize, @intCast(tmp)) else break :blk text - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*;
                    }
                }
            ...
            } else if ((textLength > @as(c_int, 0)) and ((@as(c_int, @intFromBool(IsKeyPressed(KEY_BACKSPACE))) != 0) or ((@as(c_int, @intFromBool(IsKeyDown(KEY_BACKSPACE))) != 0) and (autoCursorCooldownCounter >= @as(c_int, 40))))) {
                autoCursorDelayCounter += 1;
            ...
            if (CheckCollisionPointRec(mousePosition, textBounds)) {
                ...
                _ = &mouseCursorIndex;
                {
                    ...
                    _ = &i;
                    while (i < textLength) : (i += 1) {
                        codepoint = GetCodepointNext(&(blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk text + @as(usize, @intCast(tmp)) else break :blk text - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*, &codepointSize);
...
pub export fn GuiGrid(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_spacing: f32, arg_subdivs: c_int, arg_mouseCell: [*c]Vector2) c_int {
    ...
    _ = &linesH;
    var color: c_int = GuiGetStyle(DEFAULT, LINE_COLOR);
    _ = &color;
    if (((state != @as(c_uint, @bitCast(STATE_DISABLED))) and !guiLocked) and !guiControlExclusiveMode) {
        if (CheckCollisionPointRec(mousePoint, bounds)) {
    ...
    if (subdivs > @as(c_int, 0)) {
        {
            ...
            while (i < linesV) : (i += 1) {
                var lineV: Rectangle = Rectangle{
                    ...
                    .y = bounds.y,
                    .width = @as(f32, @floatFromInt(@as(c_int, 1))),
                    .height = bounds.height + @as(f32, @floatFromInt(@as(c_int, 1))),
                };
                _ = &lineV;
                GuiDrawRectangle(lineV, @as(c_int, 0), Color{
                    ...
                    .b = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
                    .a = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
                }, if (@import("std").zig.c_translation.signedRemainder(i, subdivs) == @as(c_int, 0)) GuiFade(GetColor(@as(c_uint, @bitCast(color))), 0.15000000596046448 * @as(f32, @floatFromInt(@as(c_int, 4)))) else GuiFade(GetColor(@as(c_uint, @bitCast(color))), 0.15000000596046448));
            }
        }
        {
            var i: c_int = 0;
            ...
            while (i < linesH) : (i += 1) {
                var lineH: Rectangle = Rectangle{
                    ...
                    .width = bounds.width + @as(f32, @floatFromInt(@as(c_int, 1))),
                    .height = @as(f32, @floatFromInt(@as(c_int, 1))),
                };
                _ = &lineH;
...
pub export fn GuiListViewEx(arg_bounds: Rectangle, arg_text: [*c][*c]const u8, arg_count: c_int, arg_scrollIndex: [*c]c_int, arg_active: [*c]c_int, arg_focus: [*c]c_int) c_int {
    ...
    GuiDrawRectangle(bounds, GuiGetStyle(LISTVIEW, BORDER_WIDTH), GetColor(@as(c_uint, @bitCast(GuiGetStyle(LISTVIEW, @as(c_int, @bitCast(@as(c_uint, @bitCast(BORDER)) +% (state *% @as(c_uint, @bitCast(@as(c_int, 3)))))))))), GetColor(@as(c_uint, @bitCast(GuiGetStyle(DEFAULT, BACKGROUND_COLOR)))));
    {
        var i: c_int = 0;
        _ = &i;
        while ((i < visibleItems) and (text != @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) : (i += 1) {
            GuiDrawRectangle(itemBounds, GuiGetStyle(LISTVIEW, LIST_ITEMS_BORDER_WIDTH), GetColor(@as(c_uint, @bitCast(GuiGetStyle(LISTVIEW, BORDER_COLOR_NORMAL)))), Color{
                .r = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
                .g = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
                .b = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
                .a = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
...
pub export fn GuiMessageBox(arg_bounds: Rectangle, arg_title: [*c]const u8, arg_message: [*c]const u8, arg_buttons: [*c]const u8) c_int {
    ...
    textBounds.width = bounds.width - @as(f32, @floatFromInt(@as(c_int, 12) * @as(c_int, 2)));
...
pub export fn GuiColorPanel(arg_bounds: Rectangle, arg_text: [*c]const u8, arg_color: [*c]Color) c_int {
    ...
    _ = &hsv;
    var prevHsv: Vector3 = hsv;
    _ = &prevHsv;
    _ = GuiColorPanelHSV(bounds, text, &hsv);
    if (((hsv.x != prevHsv.x) or (hsv.y != prevHsv.y)) or (hsv.z != prevHsv.z)) {
        var rgb: Vector3 = ConvertHSVtoRGB(hsv);
        _ = &rgb;
        color.* = Color{
...
pub var guiIcons: [2048]c_uint = [2048]c_uint{
    ...
    @as(c_uint, @bitCast(@as(c_int, 25165824))),
    @as(c_uint, @bitCast(@as(c_int, 37749312))),
    @as(c_uint, @bitCast(@as(c_int, 94372896))),
    @as(c_uint, @bitCast(@as(c_int, 160434576))),
    @as(c_uint, @bitCast(@as(c_int, 294130056))),
    @as(c_uint, @bitCast(@as(c_int, 562307076))),
    @as(c_uint, @bitCast(@as(c_int, 1073889666))),
    @as(c_uint, @bitCast(@as(c_int, 16380))),
    @as(c_uint, @bitCast(@as(c_int, 2147352576))),
    @as(c_uint, @bitCast(@as(c_int, 1341276162))),
    @as(c_uint, @bitCast(@as(c_int, 1278365682))),
    @as(c_uint, @bitCast(@as(c_int, 1333939202))),
    @as(c_uint, @bitCast(@as(c_int, 1099059074))),
    @as(c_uint, @bitCast(@as(c_int, 1099055106))),
    @as(c_uint, @bitCast(@as(c_int, 1073889666))),
    @as(c_uint, @bitCast(@as(c_int, 32766))),
    @as(c_uint, @bitCast(@as(c_int, 2147352576))),
    @as(c_uint, @bitCast(@as(c_int, 1099055106))),
    @as(c_uint, @bitCast(@as(c_int, 1073889666))),
    @as(c_uint, @bitCast(@as(c_int, 1099055490))),
    @as(c_uint, @bitCast(@as(c_int, 1099055490))),
    @as(c_uint, @bitCast(@as(c_int, 1099055490))),
    @as(c_uint, @bitCast(@as(c_int, 1073889666))),
    @as(c_uint, @bitCast(@as(c_int, 32766))),
    ...
    @as(c_uint, @bitCast(@as(c_int, 69206592))),
    @as(c_uint, @bitCast(@as(c_int, 268961808))),
    @as(c_uint, @bitCast(@as(c_int, 2078154756))),
    @as(c_uint, @bitCast(@as(c_int, 173017680))),
    @as(c_uint, @bitCast(@as(c_int, 139463632))),
    @as(c_uint, @bitCast(@as(c_int, 135268432))),
    @as(c_uint, @bitCast(@as(c_int, 4080))),
    @as(c_uint, @bitCast(@as(c_int, 25165824))),
    @as(c_uint, @bitCast(@as(c_int, 404227680))),
    2147573766,
    2551799814,
    2576967270,
    @as(c_uint, @bitCast(@as(c_int, 429418086))),
    @as(c_uint, @bitCast(@as(c_int, 25167456))),
    0,
    @as(c_uint, @bitCast(@as(c_int, 134086656))),
    @as(c_uint, @bitCast(@as(c_int, 469894146))),
    @as(c_uint, @bitCast(@as(c_int, 1946293250))),
    @as(c_uint, @bitCast(@as(c_int, 1409438722))),
    @as(c_uint, @bitCast(@as(c_int, 1409438722))),
    @as(c_uint, @bitCast(@as(c_int, 1342724094))),
    @as(c_uint, @bitCast(@as(c_int, 1075863544))),
    @as(c_uint, @bitCast(@as(c_int, 32736))),
    @as(c_uint, @bitCast(@as(c_int, 268304384))),
    @as(c_uint, @bitCast(@as(c_int, 1073350658))),
    @as(c_uint, @bitCast(@as(c_int, 2146050058))),
    @as(c_uint, @bitCast(@as(c_int, 1076510762))),
    @as(c_uint, @bitCast(@as(c_int, 1110065706))),
    @as(c_uint, @bitCast(@as(c_int, 1110327850))),
    @as(c_uint, @bitCast(@as(c_int, 1077431848))),
    @as(c_uint, @bitCast(@as(c_int, 32736))),
    @as(c_uint, @bitCast(@as(c_int, 268304384))),
    @as(c_uint, @bitCast(@as(c_int, 1073350658))),
    @as(c_uint, @bitCast(@as(c_int, 2146050058))),
    @as(c_uint, @bitCast(@as(c_int, 1076510762))),
    @as(c_uint, @bitCast(@as(c_int, 1529499946))),
    @as(c_uint, @bitCast(@as(c_int, 1361990954))),
    @as(c_uint, @bitCast(@as(c_int, 1077432616))),
    @as(c_uint, @bitCast(@as(c_int, 32736))),
    @as(c_uint, @bitCast(@as(c_int, 69206016))),
    @as(c_uint, @bitCast(@as(c_int, 485493856))),
    @as(c_uint, @bitCast(@as(c_int, 300947952))),
    @as(c_uint, @bitCast(@as(c_int, 255330232))),
    @as(c_uint, @bitCast(@as(c_int, 507252540))),
    @as(c_uint, @bitCast(@as(c_int, 471604764))),
    @as(c_uint, @bitCast(@as(c_int, 507255836))),
    @as(c_uint, @bitCast(@as(c_int, 3952))),
    0,
    0,
    0,
    0,
...
pub var guiControlExclusiveMode: bool = @as(c_int, 0) != 0;
                ...
                if (@as(c_int, @bitCast(@as(c_int, controlId))) == @as(c_int, 0)) {
                    ...
                    if (@as(c_int, @bitCast(@as(c_int, propertyId))) < @as(c_int, 16)) {
                        ...
                        while (j < @as(c_int, 16)) : (j += 1) {
                            GuiSetStyle(j, @as(c_int, @bitCast(@as(c_int, propertyId))), @as(c_int, @bitCast(propertyValue)));
                        }
                    }
                } else {
...
pub fn GuiDrawText(arg_text: [*c]const u8, arg_textBounds: Rectangle, arg_alignment: c_int, arg_tint: Color) callconv(.C) void {
    ...
    _ = &posOffsetY;
    {
        ...
        while (i < lineCount) : (i += 1) {
            ...
            var textBoundsWidthOffset: f32 = 0.0;
            _ = &textBoundsWidthOffset;
            ...
            if (((@as(f32, @floatFromInt(textSizeX)) > textBounds.width) and ((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk lines + @as(usize, @intCast(tmp)) else break :blk lines - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
            ...
            if (iconId >= @as(c_int, 0)) {
                ...
                textBoundsWidthOffset = @as(f32, @floatFromInt((@as(c_uint, @bitCast(@as(c_int, 16))) *% guiIconScale) +% @as(c_uint, @bitCast(@as(c_int, 4)))));
            }
            ...
            var scaleFactor: f32 = @as(f32, @floatFromInt(GuiGetStyle(DEFAULT, TEXT_SIZE))) / @as(f32, @floatFromInt(guiFont.baseSize));
            _ = &scaleFactor;
            var lastSpaceIndex: c_int = 0;
            _ = &lastSpaceIndex;
            var tempWrapCharMode: bool = @as(c_int, 0) != 0;
            _ = &tempWrapCharMode;
            ...
            _ = &glyphWidth;
            var ellipsisWidth: c_int = GetTextWidth("...");
            _ = &ellipsisWidth;
            var textOverflow: bool = @as(c_int, 0) != 0;
            _ = &textOverflow;
            {
                var c: c_int = 0;
                _ = &c;
                    ...
                    if (wrapMode == TEXT_WRAP_CHAR) {
                        if ((textOffsetX + glyphWidth) > (textBounds.width - textBoundsWidthOffset)) {
                            ...
                            if (tempWrapCharMode) {
                                ...
                                tempWrapCharMode = @as(c_int, 0) != 0;
                            }
                        }
                    } else if (wrapMode == TEXT_WRAP_WORD) {
                        if (codepoint == @as(c_int, 32)) {
                            lastSpaceIndex = c;
                        }
                        ...
                        _ = &nextSpaceWidth;
                        var nextSpaceIndex2: c_int = 0;
                        _ = &nextSpaceIndex2;
                        var nextWordSize: f32 = GetNextSpaceWidth(((blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk lines + @as(usize, @intCast(tmp)) else break :blk lines - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* + @as(usize, @bitCast(@as(isize, @intCast(lastSpaceIndex))))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))), &nextSpaceIndex2);
                        _ = &nextWordSize;
                        if (nextWordSize > (textBounds.width - textBoundsWidthOffset)) {
                            tempWrapCharMode = @as(c_int, 1) != 0;
                    ...
                    if (codepoint == @as(c_int, '\n')) break else {
                        if ((codepoint != @as(c_int, ' ')) and (codepoint != @as(c_int, '\t'))) {
                            if (wrapMode == TEXT_WRAP_NONE) {
                                if (@as(f32, @floatFromInt(textSizeX)) > textBounds.width) {
                                    if (textOffsetX <= (((textBounds.width - glyphWidth) - textBoundsWidthOffset) - @as(f32, @floatFromInt(ellipsisWidth)))) {
                                        ...
                                        textOverflow = @as(c_int, 1) != 0;
                                        {
                                            var j: c_int = 0;
                                            _ = &j;
                                            while (j < ellipsisWidth) : (j += @divTrunc(ellipsisWidth, @as(c_int, 3))) {
                                                DrawTextCodepoint(guiFont, @as(c_int, '.'), Vector2{
                                                    .x = (textBoundsPosition.x + textOffsetX) + @as(f32, @floatFromInt(j)),
                                                    .y = textBoundsPosition.y + @as(f32, @floatFromInt(textOffsetY)),
                                                }, @as(f32, @floatFromInt(GuiGetStyle(DEFAULT, TEXT_SIZE))), GuiFade(tint, guiAlpha));
                                            }
                                        }
...
pub fn GuiScrollBar(arg_bounds: Rectangle, arg_value: c_int, arg_minValue: c_int, arg_maxValue: c_int) callconv(.C) c_int {
    ...
    var valueRange: c_int = maxValue - minValue;
    _ = &valueRange;
    if (valueRange <= @as(c_int, 0)) {
        valueRange = 1;
    }
    var sliderSize: c_int = GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_SIZE);
    _ = &sliderSize;
    if (sliderSize < @as(c_int, 1)) {
        sliderSize = 1;
    }
...
pub fn GuiTooltip(arg_controlRec: Rectangle) callconv(.C) void {
    ...
    _ = &controlRec;
    if (((!guiLocked and (@as(c_int, @intFromBool(guiTooltip)) != 0)) and (guiTooltipPtr != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and !guiControlExclusiveMode) {
...
pub export fn GuiSliderPro(arg_bounds: Rectangle, arg_textLeft: [*c]const u8, arg_textRight: [*c]const u8, arg_value: [*c]f32, arg_minValue: f32, arg_maxValue: f32, arg_sliderWidth: c_int) c_int {
    ...
    var sliderValue: f32 = ((value.* - minValue) / (maxValue - minValue)) * ((bounds.width - @as(f32, @floatFromInt(sliderWidth))) - @as(f32, @floatFromInt(@as(c_int, 2) * GuiGetStyle(SLIDER, BORDER_WIDTH))));
    _ = &sliderValue;
...
pub fn BUTTONADD() callconv(.C) void {}
pub fn BUTTONREMOVE() callconv(.C) void {}
pub fn BUTTONRENAME() callconv(.C) void {}
pub fn BUTTONSTART() callconv(.C) void {}
pub fn LINEADD() callconv(.C) void {}
pub export fn main() c_int {
    ...
    var BUTTONLINESActive: bool = @as(c_int, 1) != 0;
    _ = &BUTTONLINESActive;
    var SLIDEPROGRESSValue: f32 = 0.0;
    _ = &SLIDEPROGRESSValue;
    var LINESELECTEditMode: bool = @as(c_int, 0) != 0;
    _ = &LINESELECTEditMode;
    var LINESELECTValue: c_int = 0;
    _ = &LINESELECTValue;
    var LINECOLORPICKValue: Color = Color{
        .r = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .g = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .b = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
        .a = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 0))))),
    };
    _ = &LINECOLORPICKValue;
    var LINENUMBEREditMode: bool = @as(c_int, 0) != 0;
    _ = &LINENUMBEREditMode;
    var LINENUMBERValue: c_int = 0;
    _ = &LINENUMBERValue;
    SetTargetFPS(@as(c_int, 60));
    while (!WindowShouldClose()) {
        BeginDrawing();
        ClearBackground(GetColor(@as(c_uint, @bitCast(GuiGetStyle(DEFAULT, BACKGROUND_COLOR)))));
        _ = GuiPanel(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 32))),
            .y = @as(f32, @floatFromInt(@as(c_int, 24))),
            .width = @as(f32, @floatFromInt(@as(c_int, 1056))),
            .height = @as(f32, @floatFromInt(@as(c_int, 616))),
        }, null);
        _ = GuiGroupBox(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 40))),
            .y = @as(f32, @floatFromInt(@as(c_int, 40))),
            .width = @as(f32, @floatFromInt(@as(c_int, 1040))),
            .height = @as(f32, @floatFromInt(@as(c_int, 504))),
        }, "CLASS");
        if (GuiButton(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 80))),
            .y = @as(f32, @floatFromInt(@as(c_int, 568))),
            .width = @as(f32, @floatFromInt(@as(c_int, 136))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, "ADD") != 0) {
            BUTTONADD();
        }
        if (GuiButton(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 240))),
            .y = @as(f32, @floatFromInt(@as(c_int, 568))),
            .width = @as(f32, @floatFromInt(@as(c_int, 136))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, "REMOVE") != 0) {
        ...
        if (GuiButton(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 400))),
            .y = @as(f32, @floatFromInt(@as(c_int, 568))),
            .width = @as(f32, @floatFromInt(@as(c_int, 136))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, "RENAME") != 0) {
        ...
        _ = GuiToggle(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 560))),
            .y = @as(f32, @floatFromInt(@as(c_int, 568))),
            .width = @as(f32, @floatFromInt(@as(c_int, 136))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, "SET LINES", &BUTTONLINESActive);
        if (GuiButton(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 824))),
            .y = @as(f32, @floatFromInt(@as(c_int, 560))),
            .width = @as(f32, @floatFromInt(@as(c_int, 176))),
            .height = @as(f32, @floatFromInt(@as(c_int, 64))),
        }, "START") != 0) {
            BUTTONSTART();
        }
        _ = GuiPanel(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 320))),
            .y = @as(f32, @floatFromInt(@as(c_int, 480))),
            .width = @as(f32, @floatFromInt(@as(c_int, 512))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, null);
        _ = GuiProgressBar(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 336))),
            .y = @as(f32, @floatFromInt(@as(c_int, 496))),
            .width = @as(f32, @floatFromInt(@as(c_int, 480))),
            .height = @as(f32, @floatFromInt(@as(c_int, 16))),
        }, null, null, &SLIDEPROGRESSValue, @as(f32, @floatFromInt(@as(c_int, 0))), @as(f32, @floatFromInt(@as(c_int, 1))));
        _ = GuiDummyRec(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 80))),
            .y = @as(f32, @floatFromInt(@as(c_int, 72))),
            .width = @as(f32, @floatFromInt(@as(c_int, 136))),
            .height = @as(f32, @floatFromInt(@as(c_int, 40))),
        }, "PERSON");
        _ = GuiPanel(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 472))),
            .y = @as(f32, @floatFromInt(@as(c_int, 480))),
            .width = @as(f32, @floatFromInt(@as(c_int, 208))),
            .height = @as(f32, @floatFromInt(@as(c_int, 48))),
        }, null);
        if (GuiSpinner(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 488))),
            .y = @as(f32, @floatFromInt(@as(c_int, 488))),
            .width = @as(f32, @floatFromInt(@as(c_int, 176))),
            .height = @as(f32, @floatFromInt(@as(c_int, 32))),
        }, null, &LINESELECTValue, @as(c_int, 0), @as(c_int, 100), LINESELECTEditMode) != 0) {
            LINESELECTEditMode = !LINESELECTEditMode;
        }
        _ = GuiPanel(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 864))),
            .y = @as(f32, @floatFromInt(@as(c_int, 152))),
            .width = @as(f32, @floatFromInt(@as(c_int, 200))),
            .height = @as(f32, @floatFromInt(@as(c_int, 264))),
        }, null);
        _ = GuiColorPicker(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 880))),
            .y = @as(f32, @floatFromInt(@as(c_int, 176))),
            .width = @as(f32, @floatFromInt(@as(c_int, 144))),
            .height = @as(f32, @floatFromInt(@as(c_int, 136))),
        }, null, &LINECOLORPICKValue);
        _ = GuiPanel(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 880))),
            .y = @as(f32, @floatFromInt(@as(c_int, 320))),
            .width = @as(f32, @floatFromInt(@as(c_int, 168))),
            .height = @as(f32, @floatFromInt(@as(c_int, 16))),
        }, null);
        if (GuiValueBox(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 880))),
            .y = @as(f32, @floatFromInt(@as(c_int, 352))),
            .width = @as(f32, @floatFromInt(@as(c_int, 112))),
            .height = @as(f32, @floatFromInt(@as(c_int, 40))),
        }, null, &LINENUMBERValue, @as(c_int, 0), @as(c_int, 100), LINENUMBEREditMode) != 0) {
            LINENUMBEREditMode = !LINENUMBEREditMode;
        }
        if (GuiButton(Rectangle{
            .x = @as(f32, @floatFromInt(@as(c_int, 1000))),
            .y = @as(f32, @floatFromInt(@as(c_int, 352))),
            .width = @as(f32, @floatFromInt(@as(c_int, 48))),
            .height = @as(f32, @floatFromInt(@as(c_int, 40))),
        }, "ADD") != 0) {
            LINEADD();
        }
...
// /usr/local/include/raygui.h:376:11
...
pub const RAYGUI_MIN_MOUSE_WHEEL_SPEED = @as(c_int, 20);
